...
void initBuildings() {
    ...
    while (totalBuildingWidth < width + 100) {
        ...
        buildings2.push_back(Rect(darkBlue,
                                  ...
                                  height-((buildingSize.height/2)+50),
                                  buildingSize));
        totalBuildingWidth += buildingSize.width + 3; // Placeholder line to avoid infinite loop
    }
    ...
    while (totalBuildingWidth < width + 200) {
        ...
        buildings3.push_back(Rect(purple,
                                  ...
                                  height-((buildingSize.height/2)+50),
                                  buildingSize));
        totalBuildingWidth += buildingSize.width + 1; // Placeholder line to avoid infinite loop
    }
}
